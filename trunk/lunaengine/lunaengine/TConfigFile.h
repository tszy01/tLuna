...
namespace TLunaEngine{
	...
	public:
		...
		bool UpdateFile(); 
		// 得到某个值
		void GetParameter(const char* paraName, TString* pBuf);
		...
		// 在内存中修改某个值
		void ChangeParameter(const char* paraName, const TString* pBuf);
		...
		// 添加一组
		void AddParameter(const char* paraName, const TString* pBuf);
