...
namespace TLunaEngine{
    ...
    */
    FORCEINLINE TU32 mostSignificantBitSet(TU32 value)
    {
        TU32 result = 0;
        while (value != 0) {
            ++result;
    ...
    */
    FORCEINLINE TU32 firstPO2From(TU32 n)
    {
        --n;            
        n |= n >> 16;
        n |= n >> 8;
    ...
    */
	template<typename T>
    FORCEINLINE TU32 getBitShift(T mask)
	{
		if (mask == 0)
			return 0;
