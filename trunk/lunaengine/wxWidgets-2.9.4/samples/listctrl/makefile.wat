...
all : .SYMBOLIC $(OBJS)\listctrl.exe
...
$(OBJS)\listctrl.exe :  $(LISTCTRL_OBJECTS) $(OBJS)\listctrl_listtest.res
	@%create $(OBJS)\listctrl.lbc
	@%append $(OBJS)\listctrl.lbc option quiet
	@%append $(OBJS)\listctrl.lbc name $^@
...
$(OBJS)\listctrl_listtest.obj :  .AUTODEPEND .\listtest.cpp
