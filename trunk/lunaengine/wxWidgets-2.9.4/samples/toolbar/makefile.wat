...
$(OBJS)\toolbar.exe :  $(TOOLBAR_OBJECTS) $(OBJS)\toolbar_toolbar.res
	@%create $(OBJS)\toolbar.lbc
	@%append $(OBJS)\toolbar.lbc option quiet
	@%append $(OBJS)\toolbar.lbc name $^@
...
$(OBJS)\toolbar_toolbar.obj :  .AUTODEPEND .\toolbar.cpp
