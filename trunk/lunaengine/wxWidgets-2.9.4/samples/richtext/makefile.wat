...
all : .SYMBOLIC $(OBJS)\richtext.exe
...
$(OBJS)\richtext.exe :  $(RICHTEXT_OBJECTS) $(OBJS)\richtext_sample.res
	@%create $(OBJS)\richtext.lbc
	@%append $(OBJS)\richtext.lbc option quiet
	@%append $(OBJS)\richtext.lbc name $^@
...
$(OBJS)\richtext_richtext.obj :  .AUTODEPEND .\richtext.cpp
